...
export function HeaderUserMenu({ user }: { user: User }) {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger className="ml-auto flex items-center gap-2 rounded-lg bg-muted px-2 py-1.5 text-left outline-none hover:bg-muted/80 focus-visible:ring-3 focus-visible:ring-ring/50">
